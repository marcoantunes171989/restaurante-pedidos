...
- **Cor:** laranja da paleta `#F38525` (hover `#F38525`), texto **branco**.
- **SEM sombra/glow:** nada de `shadow-lg shadow-[#F38525]/40`. A ênfase vem da
...
```
inline-flex items-center gap-2 rounded-xl bg-[#F38525] px-4 py-2.5 text-[13px] font-semibold text-[#012E46] transition hover:bg-[#F38525] active:scale-95
```
