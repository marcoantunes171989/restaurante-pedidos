      ...
      <div className="mt-3 grid min-w-0 grid-cols-1 gap-2 pl-2 min-[380px]:grid-cols-2">
        ...
        {pago ? (
          ...
          <button
            ...
            className="flex min-h-[44px] min-w-0 items-center justify-center gap-2 rounded-xl bg-[var(--pp-primary)] text-sm font-bold text-white transition-colors duration-150 hover:bg-[var(--pp-primary-hover)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--pp-primary-hover)]"
          >
