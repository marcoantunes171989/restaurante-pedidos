...
export default function OrderActionButton({ a, variante, compact = false }) {
  ...
  return (
    <button
      ...
      className={`btn-laranja flex items-center justify-center gap-2 rounded-xl font-bold text-[#012E46] transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--pp-primary-hover)] active:scale-[0.98] disabled:cursor-not-allowed disabled:bg-[var(--pp-bg)] disabled:text-[var(--pp-text-muted)] disabled:active:scale-100 ${
