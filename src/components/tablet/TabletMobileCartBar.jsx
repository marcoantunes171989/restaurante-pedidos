  ...
  return (
    <div className="shrink-0 border-t border-[var(--client-border)] bg-[var(--client-surface)] px-3 py-2.5 lg:hidden"
      ...
      <button type="button" onClick={onAbrir}
        className="flex h-[54px] w-full items-center justify-between gap-3 rounded-2xl bg-[var(--client-primary-hover)] px-4 text-white transition active:scale-[0.98] hover:bg-[var(--client-primary)]">
