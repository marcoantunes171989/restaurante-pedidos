...
// Ícones dos planos (reutilizados pela landing page): phone / bars / handshake
export const IcoPhone = (p) => (<svg {...sv} {...p}><rect x="6.5" y="3" width="11" height="18" rx="2.4" /><path d="M11 18h2" /></svg>);
export const IcoBars = (p) => (<svg {...sv} {...p}><rect x="4" y="13" width="3.5" height="7" rx="1" /><rect x="10.25" y="8" width="3.5" height="12" rx="1" /><rect x="16.5" y="4" width="3.5" height="16" rx="1" /></svg>);
export const IcoHandshake = (p) => (<svg {...sv} {...p}><path d="m11 17 2 2a1.5 1.5 0 0 0 2.5-1.1" /><path d="M13.5 19.4 16 17a1.5 1.5 0 0 0 2.4.4l.6-.6" /><path d="m19 17 2-2-4-6-3 1-2-1-2 1-3 4 2 2 3-2 3 3" /><path d="m3 9 4-6" /><path d="m21 9-2-3" /></svg>);
...
const cardModal = "flex w-full flex-col overflow-hidden rounded-[2rem] border border-gold-400/20 bg-[#03101C] shadow-2xl max-h-[94vh]";
