  ...
  return (
    <div className="flex flex-col gap-2 sm:flex-row-reverse">
      <button onClick={onEnviar} disabled={enviando}
        className="flex-1 rounded-2xl bg-[var(--client-primary-hover)] py-3.5 text-sm font-black text-white shadow-[var(--client-shadow-sm)] transition active:scale-95 hover:bg-[var(--client-primary)] disabled:cursor-not-allowed disabled:opacity-60">
