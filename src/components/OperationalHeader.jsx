...
/**
 * Cabeçalho operacional ÚNICO — Central, Pedidos, Cozinha, Bar e Caixa.
 * Unifica o antigo header inline de OperationalCentral e o OrdersHeader (que
 * agora é um wrapper fino sobre este), eliminando a duplicação de markup.
 * Identidade em azul petróleo (paleta oficial). Partes variáveis por props:
 *  - comLogo: exibe a marca (telas de lista = true; Central = false).
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <div role="status" className={`mb-1.5 inline-flex items-center gap-2 rounded-full border px-2.5 py-0.5 text-[11px] font-bold ${
              ...
              {online ? statusLabelOnline : "Sem conexão"}
            </div>
