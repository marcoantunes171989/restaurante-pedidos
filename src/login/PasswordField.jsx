...
const FIELD_CLS = "box-border min-h-[50px] w-full rounded-[11px] border bg-[var(--login-surface)] py-3 pl-11 pr-11 text-[16px] text-[var(--login-text-primary)] caret-[var(--login-primary)] outline-none transition-colors placeholder:text-[var(--login-text-secondary)]/70";
    ...
    <div>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`${FIELD_CLS} ${invalido ? "border-[var(--login-error)] focus:border-[var(--login-error)] focus:ring-[3px] focus:ring-[var(--login-error)]/15" : "border-[var(--login-border)] focus:border-[var(--login-primary)] focus:ring-[3px] focus:ring-[var(--login-focus)]"}`}
        />
        <button
          type="button"
