...
export default function ReleaseDrawer({ titulo, descricao = null, onFechar, children }) {
  ...
  return (
    <div className="fixed inset-0 z-[120] flex justify-end bg-black/40" onClick={onFechar} onKeyDown={onKeyDown}>
      <div
        ref={painelRef}
        role="dialog"
        aria-modal="true"
        aria-labelledby={tituloId}
        className="flex h-full w-full max-w-xl flex-col overflow-hidden border-l border-[#D1D5DB] bg-white"
