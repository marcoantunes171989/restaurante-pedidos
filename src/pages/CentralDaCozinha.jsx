...
// COLUNAS_META), preservados ao pé da letra (não são os mesmos de
// Pedidos: "Nada pronto no momento" em vez de "Nenhum pedido pronto no
// momento.", sem ponto final).
...
/**
 * Cozinha (/operacional/cozinha) — tema CLARO, dedicado a esta tela. O
 * Bar continua em src/pages/CentralDoSetor.jsx (tema escuro,
 * OperationalDarkPage/OperationalOrderCardDark), SEM NENHUMA alteração —
 * as duas telas eram o mesmo componente compartilhado antes desta
 * tarefa; a Cozinha foi desacoplada pra não mudar o Bar sem pedido para
 * isso (mesmo padrão já usado para separar Pedidos de Cozinha/Bar).
