          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {DIFERENCIAIS.map((d, i) => (
              <Reveal as="article" key={d.titulo} delay={(i % 2) * 60}
                className="rounded-[1.25rem] border border-[var(--pp-border)] bg-[var(--pp-bg)] p-5 transition hover:-translate-y-1 hover:border-[#F38525]/30">
                <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-[#F38525]/20 bg-white text-[var(--pp-primary-hover)]"><Icone nome={d.icon} className="h-5 w-5" /></span>
