        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {CANAIS.map((c, i) => (
            <Reveal as="article" key={c.id} delay={i * 70}
              className="flex flex-col rounded-[1.25rem] border border-[var(--pp-border)] bg-white p-6 transition hover:-translate-y-1 hover:border-[#C9501F]/30 hover:shadow-lg">
              ...
              <p className="mt-3 rounded-xl bg-[#D4A017]/10 px-3 py-2 text-xs font-semibold text-[var(--pp-brand-text)]">{c.beneficio}</p>
