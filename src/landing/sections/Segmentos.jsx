...
export default function Segmentos() {
  return (
    <section id="segmentos" className="scroll-mt-24 bg-[#F8FAFC] py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-5">
        ...
        <Reveal className="mt-12 flex flex-wrap justify-center gap-3">
          {SEGMENTOS.map((s) => (
            <span key={s} className="rounded-full border border-[#E2E8F0] bg-white px-4 py-2.5 text-sm font-semibold text-[#334155] shadow-sm">{s}</span>
          ))}
        </Reveal>
      </div>
    </section>
