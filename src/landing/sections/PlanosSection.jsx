              ...
              >
                <div className="relative flex flex-1 cursor-pointer flex-col" onClick={() => setSelecionadoId(p.id)}>
                  ...
                  <button
                    ...
                    className={`absolute right-0 top-0 flex h-9 w-9 items-center justify-center rounded-full border transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F38525] focus-visible:ring-offset-2 ${
                      selecionado
                  ...
                  <h3 className="mt-4 pr-10 text-xl font-bold text-[#012E46]">{p.nome}</h3>
                  ...
                  <Botao
                    ...
                    onClick={() => setSelecionadoId(p.id)}
                    className="mt-6 w-full !whitespace-normal !px-3 text-center !text-xs !leading-tight sm:!text-sm"
                  >
