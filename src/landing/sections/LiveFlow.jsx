    ...
    <section id="como-funciona" className="section scroll-mt-24 relative overflow-hidden bg-white">
      ...
      <div className="mx-auto max-w-7xl px-5">
        ...
        <Reveal delay={120} className="relative mt-14">
          ...
          <div aria-hidden="true" className="absolute left-6 top-0 hidden h-full w-px bg-gradient-to-b from-[#F38525]/40 via-[var(--pp-border)] to-[#012E46]/40 sm:hidden" />
          <div aria-hidden="true" className="absolute left-0 top-6 hidden h-px w-full bg-gradient-to-r from-[#F38525]/40 via-[var(--pp-border)] to-[#012E46]/40 sm:block" />
            ...
            {FLUXO_TEMPO_REAL.map((etapa, i) => (
              <div key={etapa.id} className="relative flex items-center gap-3 sm:flex-col sm:items-center sm:gap-0 sm:text-center">
                <div className="relative shrink-0">
                  <span aria-hidden="true" className="pp-pulse-ring absolute inset-0 rounded-2xl bg-[#F38525]/20" style={{ animationDuration: `${total * 0.6}s`, animationDelay: `${i * 0.6}s` }} />
                  <span className="relative flex h-12 w-12 items-center justify-center rounded-2xl border border-[#F38525]/20 bg-white text-[var(--pp-primary-hover)] shadow-[0_10px_26px_-20px_rgba(28,20,15,0.3)]">
