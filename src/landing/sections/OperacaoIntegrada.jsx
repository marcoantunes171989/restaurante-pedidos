  ...
  return (
    <div ref={ref} className="mx-auto mt-16 max-w-3xl">
      <div className="relative h-1 rounded-full bg-[var(--pp-border)]">
        <div className="pp-timeline-fill absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-[var(--pp-primary-hover)] to-[var(--pp-brand)]" style={{ width: ativo ? "100%" : "0%" }} />
      </div>
