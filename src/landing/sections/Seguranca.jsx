        ...
        <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-4">
          {SEGURANCA.map((s, i) => (
            <Reveal as="article" key={s.titulo} delay={(i % 4) * 70}
              className="rounded-2xl border border-[var(--pp-border)] bg-[var(--pp-bg)] p-5 transition hover:-translate-y-1 hover:border-[#F38525]/30">
              <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-[#F38525]/20 bg-white text-[var(--pp-primary-hover)]"><Icone nome={s.icon} className="h-5 w-5" /></span>
