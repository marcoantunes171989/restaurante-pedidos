        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {CENTRO_COMANDO_DESTAQUES.map((f, i) => (
            <Reveal as="article" key={f.titulo} delay={(i % 3) * 90}
              className="rounded-2xl border border-[var(--pp-border)] bg-white p-6 shadow-[0_16px_40px_-30px_rgba(28,20,15,0.25)] transition hover:-translate-y-1 hover:border-[#F38525]/30">
