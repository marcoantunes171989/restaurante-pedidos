          ...
          {ECOSSISTEMA.map((item, i) => (
            <Reveal as="article" key={item.id} delay={(i % 3) * 90}
              ...
              <div className="flex items-start gap-3 border-t border-[var(--pp-border)] p-4">
                <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-[#C63F1D]/20 bg-[#C63F1D]/5 text-[var(--pp-primary-hover)]"><Icone nome={item.icon} className="h-4.5 w-4.5" /></span>
